        ...
        <div className="hidden md:flex items-center gap-2" ref={dropdownRef}>
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 rounded-md px-2 py-1.5 text-sm transition-colors hover:bg-secondary/50"
            >
              <UserAvatar
      ...
      {mobileMenuOpen && (
        <nav className="md:hidden border-t border-border bg-card p-4">
          <div className="flex flex-col gap-2">
            ...
            <button
              onClick={handleSignOut}
              className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md text-destructive transition-colors hover:bg-secondary/50 mt-2 border-t border-border pt-4"
            >
              <LogOut className="h-4 w-4" />
              Sign out
            </button>
